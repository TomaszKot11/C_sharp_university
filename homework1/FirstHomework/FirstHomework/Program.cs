    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // List<Sensor> sensorList = new List<Sensor>();
            ...
            hs.MeasurementTaken += weatherStation.MeasurementTakenEventHandler;
            ts1.MeasurementTaken += weatherStation.MeasurementTakenEventHandler;
            ts.MeasurementTaken += weatherStation.MeasurementTakenEventHandler;
            ps.MeasurementTaken += weatherStation.MeasurementTakenEventHandler;
